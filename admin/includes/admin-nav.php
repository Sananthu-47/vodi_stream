    <div class="navbar-small mb-3">
        <div class="d-flex justify-content-between align-items-center text-white" >
            <div class="logo-holder-small"><span class="logo">Vodi</span></div>
            <div class="admin-menu-bar" id='menubar'><i class="fa fa-bars fa-2x"></i></div>
        </div>
    </div>

<div class="navbar">
    <div class="logo-holder"><span class="logo">Vodi</span><br></div>
    <ul class="side-nav">
        <a href="index.php"><li class="nav-list active_sec"><i class='fa fa-tachometer'></i><span>Dashboard</span></li></a>
