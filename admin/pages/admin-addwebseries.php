        ...
        <div class = "content">
                <div class="content-nav">
                    <div class="content-nav-left">
                        ...
                        <a href="admin-addwebseries.php" class="content-nav-badges" style="background-color: #D2DFEA;">Add Web-Series</a>
                    ...
                    <form action="" class='form-wrapper'>
                        <div class="main-content">
                            <div class="main-content-left form-group">
                                <input type="text" class="form-control" placeholder="Enter Webseries Title">
                                <br>
